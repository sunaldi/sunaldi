"""
Django settings for sunaldi project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-*!)@pdu!tz7+3nq)b24(^u1ja$#^h2@p9$&nzixoj)=j2qnb#%')
...
WSGI_APPLICATION = 'sunaldi.wsgi.application'
